...
module.exports = {
  ...
  title: "云少的笔记",
  description: '一个基于VuePress的 知识管理',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: '云少,云遇未晚,笔记,程序员,Java' }],
    ['meta', { name: 'theme-color', content: '#11a8cd' }], // 移动浏览器主题颜色
    ['meta', { name: 'referrer', content: 'no-referrer-when-downgrade' }], //解决统计不正常的问题
    ['link', { rel: 'stylesheet', href: '//at.alicdn.com/t/font_3114978_qe0b39no76.css' }], //添加消息图标 https://notes.youngkbt.cn/about/website/global-tip
  ...
  plugins: [
    ...
    // 记录曾阅读位置模块 https://notes.youngkbt.cn/about/website/lastReading/
    [
      {
        name: 'custom-plugins',
